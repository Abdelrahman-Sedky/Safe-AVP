...
/* FHA (Receive error data)
	--That's a simple code can use to check if the received data has a problem 
  // Perform input data validation to detect and reject erroneous or malformed point cloud messages
  for (const auto& msg : msgs) {
    if (!validatePointCloud(msg)) {
      RCLCPP_WARN(get_logger(), "Received an erroneous or malformed point cloud message. Ignoring...");
      return;
    }
  }
...
>>>>>>> 5dcc88378d1b12a9df93816410e0128b1e500a14
